...
## Here's the rules for selling loot you guys have found:

Anything that's gear *(daggers, potions, armor, etc)* you can sell to vendors for **half the listed value** of the item. 
...
As you level up, more items might become available in Sandpoint. 

---

the nearest large city is **Magnimar**

Shipments come in a couple times a week, so you could get someone to put in an order for something that's not available in Sandpoint. 

It will usually take 2 to 4 in-game days to get the item.
